import random #For generating random numbers(y2= offset, SH-B-1.2*offset,y1+PH-y2+offset)
...
def mainGame():
    ...
    # create 2 piles for blitting on the screen
    ...
    while True:
        ...
        if playerVelY < playerMaxValY and not playerFlapped:
        ...
        # Add a new pipe when the first is avout to go cross the leftmost part of the screen
